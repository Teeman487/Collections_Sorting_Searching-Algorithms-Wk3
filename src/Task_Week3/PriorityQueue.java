...
public class PriorityQueue {
    public static void main(String[] args) {
        // Instantiate
        Person teacher = new Person("Teacher",10,30); // insertion order preserved  // First in
        Person seniorStudent= new Person("Senior Student",2,20);// insertion order preserved  // Second in
        Person juniorStudent = new Person("Junior Student",1,15);// insertion order preserved // Last in
